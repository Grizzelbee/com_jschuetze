...
// @file        : admin/views/memberrank/tmpl/edit.php                  //
// @implements  :                                                       //
// @description : Template for the single memberrank Edit-View          //
// Version      : 1.1.4                                                 //
// *********************************************************************//
...
<form action="<?php echo JRoute::_($url.(int) $this->item->id); ?>"method="post" name="adminForm" id="adminForm">      
    ...
    <div>         
        <input type="hidden" name="task" value="jschuetze.memberrank" />
