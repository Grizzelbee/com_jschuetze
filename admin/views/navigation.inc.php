...
<div id="navcontainer">
    <ul id="navlist">
        ...
        <li<?php if ($viewName == 'memberaranks')  echo ' id="active"';?>><a href="<?php echo JRoute::_('index.php?option=com_jschuetze&view=memberranks'); ?>"><?php  echo JText::_( 'COM_JSCHUETZE_MANAGE_MEMBERRANKS' ); ?></a></li>
    </ul>
</div>