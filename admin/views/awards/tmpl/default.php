...
?> 
<form action="<?php echo JRoute::_('index.php?option=com_jschuetze&view=awards'); ?>" method="post" name="adminForm">
        ...
        <thead>
            <tr>
                ...
                <th width="5%" align="center">
                    <?php echo JHTML::_('grid.sort', 'COM_JSCHUETZE_ZUGKOENIG', 'zugkoenig', $this->listDirn, $this->listOrder); ?>
               </th>
                <th width="5%" align="center">
                    <?php echo JHTML::_('grid.sort', 'COM_JSCHUETZE_CORPSKOENIG', 'corpskoenig', $this->listDirn, $this->listOrder); ?>
               </th>
                <th width="5%" align="center">
                    <?php echo JHTML::_('grid.sort', 'COM_JSCHUETZE_BRUDERKOENIG', 'bruderkoenig', $this->listDirn, $this->listOrder); ?>
               </th>
                <th width="5%" align="center">
                ...
                <th width="12%">
                    <span>
                        ...
                        <?php echo JHTML::_('grid.order', $this->items, 'filesave.png', 'awards.saveorder'); ?>
                    </span>
                </th>
                <th width="5">
        ...
        <tbody>
            ...
            ?>
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td align="center"><?php echo JHTML::_('jgrid.published', $item->zugkoenig, $i, '' ); ?></td>
                    <td align="center"><?php echo JHTML::_('jgrid.published', $item->corpskoenig, $i, '' ); ?></td>
                    <td align="center"><?php echo JHTML::_('jgrid.published', $item->bruderkoenig, $i, '' ); ?></td>
                    <td align="center"><?php echo JHTML::_('jgrid.published', $item->pfand, $i, '' ); ?></td>
